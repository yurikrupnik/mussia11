...
import { FullstackClientRoutes } from '@mussia11/fullstack/client-routes';
  ...
  `}</pre>
      ...
      <div role="navigation">
        <ul>
          ...
          <li>
            <Link to="/client-routes">FullstackClientRoutes</Link>
          </li>
          <li>
      ...
      />
      <Route path="/client-routes" component={FullstackClientRoutes} />
      <Route
        path="/page-2"
        exact
        render={() => (
